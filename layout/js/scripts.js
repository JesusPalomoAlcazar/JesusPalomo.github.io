		...
		if(typeof $.fn.validate != 'undefined'){
			...
			$('#contact-form').validate({
				...
				messages: {
					...
					email: {
						required: "Campo requerido!",
						email: "Porfavor introduzca un email valido"
					},
					subject: {
						required: "Campo requerido!"
					},
				...
				submitHandler: function(form) {
					...
					$(form).ajaxSubmit({
						...
						success: function(msg) {
							...
							if (msg == '1') {
								result = '<div class="alert success"><i class="fa fa-check-circle-o"></i>El mensaje se ha enviado correctamente!</div>';
								$('#contact-form').clearForm();
							} else {
								result = '<div class="alert error"><i class="fa fa-times-circle"></i>No se pudo enviar el mensaje</div>';
							}
						...
						error: function() {
							...
							result = '<div class="alert error"><i class="fa fa-times-circle"></i>Error enviando el mensaje!</div>';
							$("#formstatus").html(result);
